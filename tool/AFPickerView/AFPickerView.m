...
- (void)reloadData
{
    ...
    rowsCount = (int)[dataSource numberOfRowsInPickerView:self];
...
- (UIBarButtonItem *)toolbarTitleItem:(NSString *)title {
    ...
    toolbarTitleLabel.textColor = RGBACOLOR(0, 0, 0, 1);
...
- (UIToolbar *)toolbar:(NSString *)title {
    ...
    UIBarButtonItem *doneButton = [[UIBarButtonItem alloc] initWithTitle:@"确定" style:UIBarButtonItemStyleDone target:nil action:@selector(hidePicker)];
